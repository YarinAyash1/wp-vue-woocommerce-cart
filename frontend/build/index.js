...
const CartVO = {
  ...
  methods: {
    async removeFromCart(cartItemKey) {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/wp-json/wc/store/cart/remove-item', {
        key: cartItemKey
      }, {
        headers: {
    ...
    async addToCart(productId) {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/wp-json/wc/store/cart/add-item', {
        id: productId,
        quantity: 1
      }, {
        headers: {
    ...
    async updateToCart(cartItemKey, qty) {
      ...
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/wp-json/wc/store/cart/update-item', {
          key: cartItemKey,
          quantity: qty,
    ...
    async refreshCart() {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(storeApi.get_cart);
...
/* harmony default export */ __webpack_exports__["default"] = (CartVO);
...
const Products = {
  ...
  methods: {
    async getProducts() {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(storeApi.get_products);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_cart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/cart */ "./src/components/cart.js");
/* harmony import */ var _components_product_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/product-list */ "./src/components/product-list.js");


const CartMount = Vue.createApp(_components_cart__WEBPACK_IMPORTED_MODULE_0__["default"]).mount('#cart');
const CartPage = Vue.createApp(_components_cart__WEBPACK_IMPORTED_MODULE_0__["default"]).mount('#cart-page');
const ProductsMount = Vue.createApp(_components_product_list__WEBPACK_IMPORTED_MODULE_1__["default"]).mount('#products');
